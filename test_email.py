...
app.config['MAIL_USERNAME'] = 'service@aipha.cn'  # 填邮箱
app.config["MAIL_PASSWORD"] = "ma6M4W9MSkiZcJpm"      # 填授权码
app.config['MAIL_DEFAULT_SENDER'] = 'service@aipha.cn'  # 填邮箱，默认发送者
manager = Manager(app)
mail = Mail(app)
...
def index():
    msg = Message(subject='Hello World',
                  sender="service@aipha.cn",  # 需要使用默认发送者则不用填
                  recipients=['service@aipha.cn', 'admin@akaros.cn'])
